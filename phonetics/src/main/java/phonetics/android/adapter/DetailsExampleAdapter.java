...
public class DetailsExampleAdapter extends BaseAdapter {
    ...
    public void setData(List<ExampleEntity> list) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ExampleEntity ety = (ExampleEntity) getItem(position);
        if (ety != null) {
            String example = ety.getExample();
            String[] yb_name_array = ety.getExamples_yb_name_array();
            ...
            viewHodler.tv_content.setText(example + sBuffer);
        }
